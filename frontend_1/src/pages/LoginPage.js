...
const LoginPage = () => {
  const { login, loading, error, success, clearMessages, isAuthenticated } = useApp();
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              Demo accounts: <br />
              <strong>admin@moviereview.com</strong> / admin123 <br />
              <strong>user@example.com</strong> / password123
            </p>
          </div>
        </form>
      </div>
